...
public:
  ...
  BSTElement<Key, E> *getRoot() { return root; }
...
void BST<Key, E>::clearhelp(BSTElement<Key, E> *root) {
  if (root == NULL) {
    return;
  }
...
template <typename Key, typename E>
BSTElement<Key, E> *BST<Key, E>::inserthelp(BSTElement<Key, E> *root,
...
template <typename Key, typename E>
BSTElement<Key, E> *BST<Key, E>::getmin(BSTElement<Key, E> *rt) {
  if (rt->getLeft() == NULL) {
    return rt;
  } else {
...
template <typename Key, typename E>
BSTElement<Key, E> *BST<Key, E>::deletemin(BSTElement<Key, E> *rt) {
...
template <typename Key, typename E>
BSTElement<Key, E> *BST<Key, E>::removehelp(BSTElement<Key, E> *rt,
                                            const Key &k) {
  if (rt == NULL) {
...
// Print out a BST
template <typename Key, typename E>
void BST<Key, E>::printhelp(BSTElement<Key, E> *root, int level) const {
  if (root == NULL) {
    return; // Empty tree
  }
